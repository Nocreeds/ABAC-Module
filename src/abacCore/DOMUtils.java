...
public class DOMUtils {
	...
	public static void compareNodes(Node expected, Node actual, boolean trimEmptyTextNodes)
	  ...
	  public static final void xMLPrinter(Document xml) throws Exception {
	        ...
	        tf.transform(new DOMSource(xml), new StreamResult(new File("Policies.xml")));
	  ...
	  public static void changeVal(Node node, Map<String, String> input) {
			...
			for(int i=0;i<nodes.getLength();i++) {
				...
				}else changeVal(nodes.item(i), input);
			}
		}
	...
	//Turn Input from user into XML Nodes
		public static Node creatXMLNode(Map<String, String> input) throws Exception {
			...
			else if (nodes.getLength() == 0) throw new Exception("no Model found: "+input.get("MODEL"));
